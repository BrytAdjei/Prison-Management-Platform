                ...
                <div class="container-fluid">
                    <form action="" id="inmate-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="cell_id" class="control-label">Prison & Cell Block <span style="Color:red;">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="dob" class="control-label">Birthday <span style="Color:red;">*</span></label>
                                    <input type="date" class="form-control form-control-sm rounded-0" name="dob" id="dob" required="required" value="<?= isset($dob) ? $dob : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="sex" class="control-label">Sex <span style="Color:red;">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="complexion" class="control-label">Complexion <span style="Color:red;">*</span></label>
                                    <input type="complexion" class="form-control form-control-sm rounded-0" name="complexion" id="complexion" required="required" placeholder="required" value="<?= isset($complexion) ? $complexion : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="eye_color" class="control-label">Eye Color <span style="Color:red;">*</span></label>
                                    <input type="text" class="form-control form-control-sm rounded-0" name="eye_color" id="eye_color" placeholder="required" required value="<?= isset($eye_color) ? $eye_color : "" ?>">
                                </div>
                            </div>
                        </div>
                        <fieldset class="border px-2 py-2">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="crime_ids" class="control-label">Crime Committed <span style="Color:red;">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="sentence" class="control-label">Sentence <span style="Color:red;">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="date_from" class="control-label">Time Serve Start <span style="Color:red;">*</span></label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="date_to" class="control-label">Time Serve Ends <span style="Color:red;">*</span></label>
                        ...
                        <fieldset class="border px-2 py-2">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="emergency_name" class="control-label">Name <span style="Color:red;">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="emergency_relation" class="control-label">Relation <span style="Color:red;">*</span></label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="emergency_contact" class="control-label">Contact <span style="Color:red;">*</span></label>
